  ...
  module RFC2606
    ...
    class << self
      ...
      def is_reserved(argv = '')
        ...
        return true if argv.match?(/[.](?:test|example|invalid|localhost)\z/)
        return true if argv.match?(/example[.](?:com|net|org|jp)\z/)
        return true if argv.match?(/example[.](?:ac|ad|co|ed|go|gr|lg|ne|or)[.]jp\z/)
        return false
      end
    end
  end
