  ...
  module Exim
    class << self
      ...
      def scan(mhead, mbody)
        ...
        return nil if     mhead['from'].match?(/[@].+[.]mail[.]ru[>]?/)
        ...
        while e = hasdivided.shift do
          ...
          if readcursor == 0
            ...
            if e.match?(MarkingsOf[:message])
              ...
              next unless e.match?(MarkingsOf[:frozen])
            end
          end
          ...
          unless e['alterrors'].to_s.empty?
            ...
            if e['diagnosis'].start_with?('-') || e['diagnosis'].end_with?('__')
              ...
              if e['diagnosis'].size < e['alterrors'].size
                ...
                e['diagnosis'] = e['alterrors'] if e['alterrors'].match?(rxdiagnosis)
              end
            end
            e.delete('alterrors')
          end
